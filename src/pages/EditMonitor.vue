...
<!-- SSH Monitor Config -->
                            <template v-if="monitor.type === 'ssh'">
                                ...
                                <div class="my-3">
                                    <label for="ssh-expected" class="form-label">
                                        ...
                                        <span class="text-muted fs-6">({{ $t("optional") }})</span>
                                    </label>
                            ...
                            <div v-if="monitor.type === 'port' || monitor.type === 'ping' || monitor.type === 'dns' || monitor.type === 'steam' || monitor.type === 'gamedig' ||monitor.type === 'mqtt' || monitor.type === 'radius' || monitor.type === 'tailscale-ping' || monitor.type === 'ssh'" class="my-3">
